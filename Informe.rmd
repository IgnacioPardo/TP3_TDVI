...
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Arquitectura Net1}}]{plots/Net1/graph.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Detalle Net1}}]{plots/Net1/dot.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Arquitectura Net2}}]{plots/Net2/graph.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Detalle Net2}}]{plots/Net2/dot.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Arquitectura Net3}}]{plots/Net3/graph.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Detalle Net3}}]{plots/Net3/dot.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Arquitectura NetConv}}]{plots/NetConv/graph.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Detalle NetConv}}]{plots/NetConv/dot.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Arquitectura VGG16}}]{plots/VGG16/graph.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Detalle VGG16}}]{plots/VGG16/dot.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Arquitectura VGG19}}]{plots/VGG19/graph.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Detalle VGG19}}]{plots/VGG19/dot.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Arquitectura InceptionNet}}]{plots/InceptionNetV1/graph.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Detalle InceptionNet}}]{plots/InceptionNetV1/dot.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Arquitectura ResNet}}]{plots/ResNet/graph.gv.pdf}
\includepdf[pages=1, pagecommand={\thispagestyle{plain}\section{Detalle ResNet}}]{plots/ResNet/dot.gv.pdf}
